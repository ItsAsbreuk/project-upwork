...
import "../assets/css/pages/faq.scss";

import React, {PropTypes} from "react";
import TitleHeader from "../modules/title-header.jsx";
import ContentFaq from "../modules/faq/content-faq.jsx";
import Footer from "../react-components/footer.jsx";

const ViewFAQ = React.createClass({
    ...
    render() {
        ...
        return (
            <div className="container-fluid ezh-no-padding ezh-faq-container">
                <div>
                    <TitleHeader
                        titleHeader={props.titleHeader}
                        titleSubHeader={props.titleSubHeader} />
                    <ContentFaq faq={props.faq} />
                    <Footer
