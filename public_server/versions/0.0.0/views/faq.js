...
/******/ 	__webpack_require__.p = "assets/0.0.0/";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(6),
	    HtmlPage = __webpack_require__(196),
	    Body = __webpack_require__(249),
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	// add support for deepcloning object

	var _redux = __webpack_require__(93);

	var _reducersCombined = __webpack_require__(199);

	var _reducersCombined2 = _interopRequireDefault(_reducersCombined);

	var _initialState = __webpack_require__(56);

	var _initialState2 = _interopRequireDefault(_initialState);

	var _itsaReduxClientstorage = __webpack_require__(111);

	var _itsaReduxClientstorage2 = _interopRequireDefault(_itsaReduxClientstorage);
	...
	var AppStore = function AppStore() {
	  var state = undefined;
	  if (!_store) {
	    useLocalStorage && (state = _itsaReduxClientstorage2["default"].readStateFromClientStorage(_initialState2["default"]));

	    state = _initialState2["default"].deepClone();
	    _store = (0, _redux.createStore)(_reducersCombined2["default"], state);

	    useLocalStorage && _itsaReduxClientstorage2["default"].watch(_store);
	  }
	  return _store;
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	__webpack_require__(117); // need promises

	var createHashMap = __webpack_require__(114).createMap,
	    TYPES = createHashMap({
	    'undefined': true,
	    'number': true,
	    'boolean': true,
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var keys = Object.keys(initialState.signupuser);
	keys.forEach(function (key) {
	  // only inspect primary type-properties of initialState.signupuser
	  if (typeof initialState.signupuser[key] !== "object") {
	    initialState.signupuser.validated[key] = (0, _validate2["default"])(initialState.signupuser[key], initialState.signupuser.validators[key]);
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsIsPlainObject = __webpack_require__(95);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsCompose = __webpack_require__(94);
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var _appStore = __webpack_require__(34);

	var _appStore2 = _interopRequireDefault(_appStore);

	var MixinStateListener = {
	  ...
	  componentDidMount: function componentDidMount() {
	    this.unSubscribeStore = _appStore2["default"].subscribe(this.forceUpdate.bind(this));
	  },
	...
	exports["default"] = MixinStateListener;
	module.exports = exports["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	// enable `String.validateEmail`

	var REG_EXP_PHONE = /^\(\d{0,3}\) \d{0,3}\-\d{0,4}$/;
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var _reduxAppStore = __webpack_require__(34);

	var _reduxAppStore2 = _interopRequireDefault(_reduxAppStore);

	var _reduxActionsToggleNavbarCollapsed = __webpack_require__(198);

	var _reduxActionsToggleNavbarCollapsed2 = _interopRequireDefault(_reduxActionsToggleNavbarCollapsed);

	var _reduxStateListenerMixin = __webpack_require__(97);

	var _reduxStateListenerMixin2 = _interopRequireDefault(_reduxStateListenerMixin);

	var _node_modulesEzhomeEzhThemeAppImagesLogoWhiteSvg = __webpack_require__(100);

	var _node_modulesEzhomeEzhThemeAppImagesLogoWhiteSvg2 = _interopRequireDefault(_node_modulesEzhomeEzhThemeAppImagesLogoWhiteSvg);

	var _node_modulesEzhomeEzhThemeAppImagesLogoColoredSvg = __webpack_require__(99);

	var _node_modulesEzhomeEzhThemeAppImagesLogoColoredSvg2 = _interopRequireDefault(_node_modulesEzhomeEzhThemeAppImagesLogoColoredSvg);

	var urlLogin = "http://my.ezhome.com/login/";
	...
	var Navbar = _react2["default"].createClass({
	    ...
	    propTypes: {
	        ...
	        */
	         ...
	         * @since 2.0.0
	        */
	        hideLinks: _react.PropTypes.bool,
	         ...
	         * @since 2.0.0
	        */
	        lightNav: _react.PropTypes.bool,
	         ...
	         * @since 2.0.0
	        */
	        navEmpty: _react.PropTypes.bool
	    },
	     ...
	     * @since 2.0.0
	     */
	    mixins: [_reduxStateListenerMixin2["default"]],
	     ...
	     * @since 2.0.0
	     */
	    getHamburgerButton: function getHamburgerButton() {
	        // use <a> instead of <button> here to fix weird intermittent rendering issues in Chrome
	        var classname = undefined;
	        if (this.props.hideLinks) {
	            classname = (this.props.lightNav ? "ezh-btn-outline-dark " : "") + "navbar-right visible-xs-inline-block pull-right u-mr15 btn " + "btn-default ezh-btn-outline btn-sm navbar-btn";
	            return _react2["default"].createElement(
	                "a",
	                { className: classname, href: urlLogin },
	                "Login"
	            );
	        }
	        classname = (_reduxAppStore2["default"].getState().navbarcollapsed ? "collapsed " : "") + "navbar-toggle";
	        return _react2["default"].createElement(
	            "a",
	            { className: classname, onClick: this.toggleNavbar, role: "button" },
	    ...
	    toggleNavbar: function toggleNavbar() {
	        _reduxAppStore2["default"].dispatch((0, _reduxActionsToggleNavbarCollapsed2["default"])());
	        return this;
	    },
	    ...
	    render: function render() {
	        var links = undefined,
	            navClass = undefined,
	            loginClass = undefined,
	            vendorImage = undefined,
	            component = undefined,
	            classnameNavCollapse = undefined;
	        if (this.props.navEmpty) {
	            navClass = this.props.className;
	            component = _react2["default"].createElement(
	                "a",
	                { className: "nav-brand", href: "/#" },
	                _react2["default"].createElement("img", { height: "30", src: _node_modulesEzhomeEzhThemeAppImagesLogoWhiteSvg2["default"] })
	            );
	        } else {
	            navClass = (this.props.className ? this.props.className + " " : "") + "navbar navbar-default ezh-navbar";
	            loginClass = (this.props.lightNav ? "ezh-btn-outline-dark " : "") + "navbar-right btn btn-default ezh-btn-outline btn-sm navbar-btn", classnameNavCollapse = (_reduxAppStore2["default"].getState().navbarcollapsed ? "" : "in ") + "navbar-collapse collapse", vendorImage = this.props.lightNav ? _node_modulesEzhomeEzhThemeAppImagesLogoColoredSvg2["default"] : _node_modulesEzhomeEzhThemeAppImagesLogoWhiteSvg2["default"];
	            ...
	            component = _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement("img", { height: "30", src: vendorImage })
	                    )
	                ),
	                _react2["default"].createElement(
	                    "div",
	                    { className: classnameNavCollapse, id: "ezh-navbar-collapse" },
	                    _react2["default"].createElement(
	                        "a",
	                        { className: loginClass, href: urlLogin },
	                        "Login"
	                    ),
	                    links
	                )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(6),
	    ReactDOM = __webpack_require__(102),
	    DOCUMENT = WINDOW.document,
	    HEAD = DOCUMENT.head,
	    async = __webpack_require__(106).async,
	    Classes = __webpack_require__(101);
	...
	var Controller = Classes.createClass({
	    ...
	    _renderCss: function _renderCss() {
	        var instance = this;
	        if (instance.css) {
	            if (instance.linkNode) {
	    ...
	    _createBodyElement: function _createBodyElement(props) {
	        var instance = this,
	    ...
	    _markHeadAttr: function _markHeadAttr() {
	    ...
	    getRequireId: function getRequireId() {
	    ...
	    isStaticView: function isStaticView() {
	    ...
	    getBodyComponent: function getBodyComponent() {
	    ...
	    getBodyComponentInstance: function getBodyComponentInstance() {
	        return this._currentComponent;
	    },

	    forceUpdate: function forceUpdate(newProps) {
	        var instance = this;
	    ...
	    setPage: function setPage(config /* view, BodyComponent, title, props, css, staticView, componentId, requireId */) {
	        var instance = this;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	   idGenerator: __webpack_require__(107).idGenerator,
	   later: __webpack_require__(57).later,
	   async: __webpack_require__(57).async
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TransferedProperties = React.createClass({
	    ...
	    render: function render() {
	        ...
	        var scriptContent = {
	            __html: TEXTObjectStringToDates + 'window.__itsa_react_server||(window.__itsa_react_server={});' + 'try {' + // NOTE: eval must start with 0?0: for IE9 compatibility --> see http://stackoverflow.com/questions/6807649/problems-with-ie9-javascript-eval
	            'window.__itsa_react_server.props=Object.stringToDates(eval(0?0:' + JSON.stringify(this.props.clientProps) + '))' + '}' + 'catch(e) {' + 'console.warn(\'eval-error2:\',e);window.__itsa_react_server.props={}' + '}'
	        };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isNode = typeof global !== 'undefined' && ({}).toString.call(global) === '[object global]' && (!global.document || ({}).toString.call(global.document) !== '[object HTMLDocument]'),
	    ...
	    objectAssign = __webpack_require__(113),
	    localStorage = __webpack_require__(112),
	    KEY_ID = 'itsaRefluxClientStorage',
	    MIN_SESSION_BROWSERS_NO_HISTORY = 3600; // sec

	var setupListener = function setupListener(store) {
	    if (alreadySet) {
	        return;
	    }
	...
	var ReduxClientStorageMixin = {
	    ...
	    readStateFromClientStorage: function readStateFromClientStorage(initialState) {
	        var localState;
	        if (this.envBrowser() && localStorage) {
	            var controller = __webpack_require__(105),
	                sessionTime;
	            controller.init();
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var _itsaReactServerWebpackBuilderCoreComponentsTransferedProperties = __webpack_require__(110);

	var _itsaReactServerWebpackBuilderCoreComponentsTransferedProperties2 = _interopRequireDefault(_itsaReactServerWebpackBuilderCoreComponentsTransferedProperties);

	var NON_CLIENT_PROPS = {
	...
	var HtmlPage = _react2["default"].createClass({
	  ...
	  propTypes: {
	     ...
	     * @since 2.0.0
	    */
	    __charset: _react.PropTypes.string.isRequired,
	     ...
	     * @since 2.0.0
	    */
	    __description: _react.PropTypes.string.isRequired,
	     ...
	     * @since 2.0.0
	    */
	    __device: _react.PropTypes.string.isRequired,
	    ...
	    */
	     ...
	     * @since 2.0.0
	    */
	    __itsacommonscript: _react.PropTypes.string,
	     ...
	     * @since 2.0.0
	    */
	    __itsapageinlinecss: _react.PropTypes.oneOfType([_react.PropTypes.bool, _react.PropTypes.object]),
	     ...
	     * @since 2.0.0
	    */
	    __itsapagelinkcss: _react.PropTypes.string,
	     ...
	     * @since 2.0.0
	    */
	    __itsapagescript: _react.PropTypes.string,
	     ...
	     * @since 2.0.0
	    */
	    __lang: _react.PropTypes.string.isRequired,
	     ...
	     * @since 2.0.0
	    */
	    __title: _react.PropTypes.string.isRequired,
	     ...
	     * @since 2.0.0
	    */
	    __view: _react.PropTypes.string.isRequired,
	     ...
	     * @since 2.0.0
	    */
	    __viewport: _react.PropTypes.string.isRequired,
	   ...
	   */
	  render: function render() {
	    var googleAnalyticsInit = undefined,
	        gaInit = undefined,
	        ga = undefined,
	        pagecss = undefined,
	    ...
	    var that = this,
	        commonscript = this.props.__itsacommonscript && _react2["default"].createElement("script", { src: this.props.__itsacommonscript }),
	        pagescript = this.props.__itsapagescript && _react2["default"].createElement("script", { src: this.props.__itsapagescript });
	    ...
	    if (this.props.__ga) {
	      ...
	      googleAnalyticsInit = _react2["default"].createElement("script", { dangerouslySetInnerHTML: gaInit });
	      ga = { __html: "ga(\"create\",\"" + this.props.__ga + "\",\"auto\");ga(\"send\",\"pageview\");" };
	      googleAnalyticsGa = _react2["default"].createElement("script", { dangerouslySetInnerHTML: ga });
	    }
	    ...
	    if (this.props.__itsapagelinkcss) {
	      pagecss = _react2["default"].createElement("link", {
	        "data-src": "inline",
	        href: this.props.__itsapagelinkcss,
	        rel: "stylesheet" });
	    } else if (this.props.__itsapageinlinecss) {
	      pagecss = _react2["default"].createElement("style", {
	    ...
	    return _react2["default"].createElement(
	      "html",
	      { "data-device": this.props.__device, "data-page": this.props.__view, lang: this.props.__lang },
	      _react2["default"].createElement(
	        "head",
	        null,
	        _react2["default"].createElement("meta", { charSet: this.props.__charset }),
	        _react2["default"].createElement("meta", { content: this.props.__viewport, name: "viewport" }),
	        _react2["default"].createElement("meta", { content: this.props.__description, name: "description" }),
	        pagecss,
	        _react2["default"].createElement(
	          "title",
	          null,
	        ...
	        _react2["default"].createElement("link", { href: "/images/favicon/favicon.ico", rel: "shortcut icon", type: "image/x-icon" }),
	        _react2["default"].createElement("link", { href: "/images/favicon/favicon-57x57.png", rel: "apple-touch-icon", sizes: "57x57" }),
	        _react2["default"].createElement("link", { href: "/images/favicon/favicon-60x60.png", rel: "apple-touch-icon", sizes: "60x60" }),
	        _react2["default"].createElement("link", { href: "/images/favicon/favicon-72x72.png", rel: "apple-touch-icon", sizes: "72x72" }),
	        _react2["default"].createElement("link", { href: "/images/favicon/favicon-76x76.png", rel: "apple-touch-icon", sizes: "76x76" }),
	        _react2["default"].createElement("link", { href: "/images/favicon/favicon-114x114.png", rel: "apple-touch-icon", sizes: "114x114" }),
	        _react2["default"].createElement("link", { href: "/images/favicon/favicon-120x120.png", rel: "apple-touch-icon", sizes: "120x120" }),
	        _react2["default"].createElement("link", { href: "/images/favicon/favicon-144x144.png", rel: "apple-touch-icon", sizes: "144x144" }),
	        _react2["default"].createElement("link", { href: "/images/favicon/favicon-152x152.png", rel: "apple-touch-icon", sizes: "152x152" }),
	        _react2["default"].createElement("link", { href: "/images/favicon/favicon-16x16.png", rel: "icon", sizes: "16x16", type: "image/png" }),
	        _react2["default"].createElement("link", { href: "/images/favicon/favicon-32x32.png", rel: "icon", sizes: "32x32", type: "image/png" }),
	        _react2["default"].createElement("link", { href: "/images/favicon/favicon-48x48.png", rel: "icon", sizes: "48x48", type: "image/png" }),
	        _react2["default"].createElement("link", { href: "/images/favicon/favicon-64x64.png", rel: "icon", sizes: "64x64", type: "image/png" }),
	        _react2["default"].createElement("link", { href: "/images/favicon/favicon-96x96.png", rel: "icon", sizes: "96x96", type: "image/png" }),
	        _react2["default"].createElement("link", { href: "/images/favicon/favicon-192x192.png", rel: "icon", sizes: "192x192", type: "image/png" }),
	        _react2["default"].createElement("link", { href: "/images/favicon/manifest.json", rel: "manifest" }),
	        _react2["default"].createElement("meta", { content: "#0c793d", name: "msapplication-TileColor" }),
	        _react2["default"].createElement("meta", { content: "/images/favicon/favicon-white-144x144.png", name: "msapplication-TileImage" }),
	        _react2["default"].createElement("meta", { content: "#0c793d", name: "theme-color" }),
	        googleAnalyticsInit
	      ),
	      _react2["default"].createElement(
	        "body",
	        ...
	        _react2["default"].createElement(_itsaReactServerWebpackBuilderCoreComponentsTransferedProperties2["default"], { clientProps: clientProps }),
	        commonscript,
	        pagescript,
	        googleAnalyticsGa
	      )
	...
	*/
	...
	var Footer = _react2["default"].createClass({
	    ...
	    propTypes: {
	         ...
	         * @since 2.0.5
	        */
	        ezhomeURLs: _react.PropTypes.object.isRequired,
	         ...
	         * @since 2.0.0
	        */
	        lightFooter: _react.PropTypes.bool
	    },
	    ...
	    render: function render() {
	        var props = this.props,
	            footClass = (props.lightFooter ? "ezh-standard-footer-light " : "") + "ezh-footer ezh-standard-footer",
	            vendorImage = this.props.lightFooter ? _node_modulesEzhomeEzhThemeAppImagesLogoColoredSvg2["default"] : _node_modulesEzhomeEzhThemeAppImagesLogoWhiteSvg2["default"];
	        ...
	        return _react2["default"].createElement(
	            ...
	            _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(
	                        "a",
	                        { className: "ezh-footer-logo", href: "/" },
	                        _react2["default"].createElement("img", { src: vendorImage })
	                    )
	                ),
	                _react2["default"].createElement(
	                    "li",
	            ...
	            _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(
	                        "a",
	                        { "data-external-link": "", "data-label": "facebook", href: props.ezhomeURLs.facebook, target: "_blank" },
	                ...
	                _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(
	                        "a",
	                        { "data-external-link": "", "data-label": "twitter", href: props.ezhomeURLs.twitter, target: "_blank" },
	                ...
	                _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(
	                        "a",
	                        { "data-external-link": "", "data-label": "instagram", href: props.ezhomeURLs.instagram, target: "_blank" },
	                ...
	                _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(
	                        "a",
	                        { "data-external-link": "", "data-label": "pinterest", href: props.ezhomeURLs.pinterest, target: "_blank" },
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var _signupuser = __webpack_require__(202);

	var _signupuser2 = _interopRequireDefault(_signupuser);

	var _detailpage = __webpack_require__(200);

	var _detailpage2 = _interopRequireDefault(_detailpage);

	var _navbarcollapsed = __webpack_require__(201);

	var _navbarcollapsed2 = _interopRequireDefault(_navbarcollapsed);

	var _redux = __webpack_require__(93);

	var appReducer = (0, _redux.combineReducers)({
	  signupuser: _signupuser2["default"],
	  detailpage: _detailpage2["default"],
	  navbarcollapsed: _navbarcollapsed2["default"]
	});
...
/***/ function(module, exports) {
	...
	*/
	...
	var detailpage = function detailpage(state, action) {
	    if (state === undefined) {
	        state = 0;
	    }
...
/***/ function(module, exports) {
	...
	*/
	...
	var navbarcollapsed = function navbarcollapsed(state, action) {
	    if (state === undefined) {
	        state = true;
	    }
	...
	exports["default"] = navbarcollapsed;
	module.exports = exports["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	// enable object.deepClone() and Object.isObject()
	...
	*/
	...
	var tryValidate = function tryValidate(state, field) {
	    var validator = state.validators[field];
	    validator && (state.validated[field] = (0, _validate2["default"])(state[field], validator));
	};

	var hasCitySupport = function hasCitySupport(zipcode, zipCodes) {
	    return zipCodes.indexOf(zipcode) > -1;
	};

	var signupuser = function signupuser(state, action) {
	    var newState = undefined;
	    if (state === undefined) {
	        newState = _initialState2["default"].signupuser.deepClone();
	    } else {
	    ...
	    if (action.type === "RESET_SIGNUPUSER") {
	        ...
	        newState.homeaddress.city = "", newState.homeaddress.cityCustomers = {};
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var _reactComponentsNavbarJsx = __webpack_require__(103);

	var _reactComponentsNavbarJsx2 = _interopRequireDefault(_reactComponentsNavbarJsx);

	// because we set propTypes, we will use React.createClass instead of extend Component.
	var TitleHeader = _react2["default"].createClass({
	    ...
	    propTypes: {
	         ...
	         * @since 2.0.0
	        */
	        titleHeader: _react.PropTypes.string,
	         ...
	         * @since 2.0.0
	        */
	        titleSubHeader: _react.PropTypes.string
	    },
	     ...
	     */
	    render: function render() {
	        var titleHeader = this.props.titleHeader && _react2["default"].createElement(
	            "h1",
	            null,
	            this.props.titleHeader
	        ),
	            titleSubHeader = this.props.titleSubHeader && _react2["default"].createElement(
	            "h2",
	            null,
	            this.props.titleSubHeader
	        );

	        return _react2["default"].createElement(
	            "div",
	            { className: "ezh-hero ezh-hero-with-nav ezh-hero-with-overlay" },
	            _react2["default"].createElement("div", { className: "ezh-hero-overlay" }),
	            _react2["default"].createElement(_reactComponentsNavbarJsx2["default"], { className: "navbar" }),
	            _react2["default"].createElement(
	                "div",
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var categoryBaseClass = "ezh-button-list-icon-faq ezh-button-list-icon-sm ";

	var ContentFAQ = _react2["default"].createClass({
	    ...
	    propTypes: {
	         ...
	         * @since 2.0.0
	        */
	        faq: _react.PropTypes.array.isRequired
	    },
	    ...
	    generateIcons: function generateIcons() {
	        return this.props.faq.map(function (category, i) {
	            var href = "#" + category.slug,
	            ...
	            return _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(
	                    "a",
	                    { className: "ezh-button-list-item ezh-button-list-item-lg", href: href },
	    ...
	    generateFAQ: function generateFAQ() {
	        var faq = [];
	        var generateCategoryQuestions = function generateCategoryQuestions(questions, answers) {
	            return questions.map(function (question, i) {
	                return _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement("div", { dangerouslySetInnerHTML: answers[i] })
	                );
	            });
	        };

	        this.props.faq.forEach(function (category, i) {
	            var categoryQuestions = generateCategoryQuestions(category.questions, category.answers),
	                classname = "container ezh-fixed-container ezh-spaced-sections-60 " + "ezh-container-padded-top ezh-container-padded-bottom",
	                keyAnchor = "a" + i;

	            faq.push(_react2["default"].createElement("a", { id: category.slug, key: keyAnchor, name: category.slug }));
	            faq.push(_react2["default"].createElement(
	                "div",
	                { className: "ezh-fluid-container ezh-subtle-bordered-bottom", key: i },
	                _react2["default"].createElement(
	                    "div",
	                    { className: classname },
	                    _react2["default"].createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	/**
	 * Faq view react-component, which gets rendered after the router invokes "reply.reactview("faq");"
	 *
	 * <i>Copyright (c) 2015 ezHome - http://ezhome.com</i><br>
	 * Proprietary License
	 *
	 *
	 * @module views/faq.jsx
	 * @class ViewFAQ
	 * @since 2.0.0
	*/
	...
	var _modulesTitleHeaderJsx = __webpack_require__(205);

	var _modulesTitleHeaderJsx2 = _interopRequireDefault(_modulesTitleHeaderJsx);

	var _modulesFaqContentFaqJsx = __webpack_require__(225);

	var _modulesFaqContentFaqJsx2 = _interopRequireDefault(_modulesFaqContentFaqJsx);

	var _reactComponentsFooterJsx = __webpack_require__(197);

	var _reactComponentsFooterJsx2 = _interopRequireDefault(_reactComponentsFooterJsx);

	var ViewFAQ = _react2["default"].createClass({
	  displayName: "ViewFAQ",
	   ...
	   */
	  render: function render() {
	    var props = this.props; // for optimization uglifyJS
	    ...
	    return _react2["default"].createElement(
	      ...
	      _react2["default"].createElement(
	        "div",
	        null,
	        _react2["default"].createElement(_modulesTitleHeaderJsx2["default"], {
	          titleHeader: props.titleHeader,
	          titleSubHeader: props.titleSubHeader }),
	        _react2["default"].createElement(_modulesFaqContentFaqJsx2["default"], { faq: props.faq }),
	        _react2["default"].createElement(_reactComponentsFooterJsx2["default"], {
